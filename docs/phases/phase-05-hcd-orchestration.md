...
- [x] [User action] A real Nushell/Herdr end-to-end run is optional and is not a
      normal automated-test prerequisite.
- [x] [User confirmation] Review the behavior matrix and, if performed, the
...
- [x] [User confirmation] Complete `hcd` behavior is approved.
