...
- [x] [User action] Push the implementation branch manually when remote CI
      verification is desired; agents never push.
- [x] [User action] Open or update the pull request and allow the Linux/macOS
      checks to complete.
- [x] [User confirmation] Review CI results, installation documentation, and
      the final implementation diff.
- [x] [User confirmation] Approve version 0.1.0 source-distribution readiness;
      publishing to any registry remains a separate future decision.

## Phase gate

- [x] [Agent] The complete local quality suite passes.
- [x] [User action] Hosted Linux/macOS CI passes when a GitHub pull request is
      part of the chosen delivery workflow.
- [x] [Agent] Source installation and plugin-registration documentation matches
      verified commands.
- [x] [User confirmation] The final quality and source-readiness review is
      approved.
