...
| 4     | [Herdr actions](phase-04-herdr-actions.md)              | 12, 14–18              | Exact pane focus and create transports             | Action safety review                        | Implemented; awaiting confirmation |
...
Current progress: Phases 1–3 are complete. Phase 4 is implemented and
awaiting the action safety review.
